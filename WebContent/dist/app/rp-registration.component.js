...
var RpRegistrationComponent = (function () {
    function RpRegistrationComponent(ics, _router, route, http, sanitizer) {
        this.ics = ics;
    ...
    RpRegistrationComponent.prototype.calculateCurrentAge = function () {
    ...
    RpRegistrationComponent.prototype.calculateAge = function () {
        var timeDiff = Math.abs(this._joiningDate.getTime() - this._dob.getTime());
        var age = Math.floor((timeDiff / (1000 * 3600 * 24)) / 365.25);
        console.log(age);
        this._age = age;
    };
    RpRegistrationComponent.prototype.getFileDetails = function (event) {
    ...
    RpRegistrationComponent.prototype.goUpload = function () {
        var _this = this;
    ...
    RpRegistrationComponent.prototype.goRegister = function () {
        ...
        if (this._filePath != undefined && this._filePath != null) {
            var profile = { "centerNo": this._centerNo, "groupNo": this._groupNo, "loaneeNo": this._loaneeNo, "collectionDay": this._collectionDay,
    ...
    RpRegistrationComponent.prototype.checkData = function () {
    ...
    RpRegistrationComponent.prototype.goCancel = function () {
        this._centerNo = "";
        this._groupNo = "";
        this._loaneeNo = "";
        this._collectionDay = "";
    ...
    RpRegistrationComponent._objst = { "cdcno": "", "appId": "", "name": "", "qNo": "", "email": "", "tNo": "", "appDate": null, "passNo": "", "appointmentDate": "" };
    RpRegistrationComponent = __decorate([
        core_1.Component({
    ...
    return RpRegistrationComponent;
}());
exports.RpRegistrationComponent = RpRegistrationComponent;
//# sourceMappingURL=rp-registration.component.js.map