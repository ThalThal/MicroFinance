...
var RpHttpService = (function () {
    ...
    RpHttpService.prototype.upload = function (url, files) {
        var fd = new FormData();
        fd.append("uploadedFile", files);
        return this.http.post(url, fd).map(function (res) { return res.json(); });
    };
...
exports.RpHttpService = RpHttpService;
