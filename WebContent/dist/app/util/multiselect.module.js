...
var multiselect_dropdown_1 = require('../util/multiselect-dropdown');
var multiselect_pipe_module_1 = require('../util/multiselect-pipe.module');
    ...
    MultiselectModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                multiselect_pipe_module_1.MultiselectPipeModule,
                forms_2.ReactiveFormsModule
            ],
            declarations: [
                multiselect_dropdown_1.MultiselectDropdown
            ],
            exports: [
                multiselect_dropdown_1.MultiselectDropdown
            ],
