...
var RpSIDUpdateComponent = (function () {
    function RpSIDUpdateComponent(ics, _router, route, http, sanitizer) {
        var _this = this;
        this.ics = ics;
        ...
        this.sub = this.route.params.subscribe(function (params) {
            var cdcno = params['cdcno'];
            if (cdcno != null && cdcno != "") {
                console.log(params['cdcno']);
                _this._obj.cdcno = params['cdcno'];
                _this.goPost(_this._obj.cdcno);
            }
        });
    }
    RpSIDUpdateComponent.prototype.gologout = function () {
        this._cdcno = "";
        RpSIDUpdateComponent._objst = { "cdcno": "", "appId": "", "name": "", "qNo": "", "appointmentDate": "", "email": "", "tNo": "", "appDate": null, "passNo": "" };
        this._router.navigate(['/SIDLogin']);
    };
    RpSIDUpdateComponent.prototype.goBack = function () {
        this._router.navigate(['/SID']);
    };
    RpSIDUpdateComponent.prototype.checkLogin = function () {
        if (this.ics._sidprofile.check == false || this.ics._sidprofile.username == "" || this.ics._sidprofile.role != 2) {
            this._router.navigate(['/SIDLogin']);
        }
    };
    RpSIDUpdateComponent.prototype.goPost = function (cdcno) {
        var _this = this;
    ...
    RpSIDUpdateComponent.prototype.goUpdate = function () {
        var _this = this;
    ...
    RpSIDUpdateComponent._objst = { "cdcno": "", "appId": "", "name": "", "qNo": "", "email": "", "tNo": "", "appDate": null, "passNo": "", "appointmentDate": "" };
    RpSIDUpdateComponent = __decorate([
        core_1.Component({
    ...
    return RpSIDUpdateComponent;
}());
exports.RpSIDUpdateComponent = RpSIDUpdateComponent;
//# sourceMappingURL=rp-sidupdate.component.js.map