...
function isUnicode_my(string) {

	for(var i=0; i<reUnicode_my.length; i++){

		if(reUnicode_my[i].test(string)) return true;
...
function isZawgyi(string){
    for(var i=0; i<reZawgyi.length; i++){
        if(reZawgyi[i].test(string)) return true;
    }
    return false;
}

function identifyFont(string){
    
    if(!isUnicode_my(string) || isZawgyi(string)){
		var res ="zawgyi";
		return res;
    }
	if(isUnicode_my(string)){
		var res ="unicode";
		return res;
	}
}
//...........................ztouni.................................//
function ZgtoUni(zgtext)
{
   var utext = zgtext;
...
function myFunction() {
 // location.replace("https://10.1.200.13:5001")
//window.location.href = "https://10.1.200.13:5001";
window.location.assign("http://10.1.200.13:5000");
//location.reload(true); //to force a network request
/*if(window.location.protocol != 'https:') {
  location.href =   location.href.replace("http://", "https://");
}*/
//var url = "https://"
//window.location.href = url +"10.1.200.13:5001";
//document.write(window.location.href);
 
/*const Http = new XMLHttpRequest();
const url='https/10.1.200.13:5001';
Http.open("GET", url);
Http.send
