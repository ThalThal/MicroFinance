...
public class LogInHistoryDataSet {
	...
	private ArrayList<LogInHistoryData> m_arlData;
	...
	private void clearProperties() {
		...
		m_pageSize = 0;
		state = false;
		m_arlData = new ArrayList<>();
		data = new LogInHistoryData[0];
	}
	...
	public ArrayList<LogInHistoryData> getM_arlData() {
		return m_arlData;
	}

	public void setM_arlData(ArrayList<LogInHistoryData> m_arlData) {
